/*
Senghak Heng: input_exception class
Lindsey Yobo: modify main method
SethaSebastian Yem: try catch block 
*/
...
class input_exception : exception{
    private:
        string message;
    public:
        input_exception(): message("Exception caught"){}
        input_exception(string msg): message(msg){};
	...
	do {
		do{
            try
            {
                ...
                cout << "That's not a number between 0 and 3!" << e.what() << endl;
            }
			...
			case 1:
				do {
                    try
                    {
                        ...
                        cout << "That's not a positive number!" << e.what() << endl;
                    }
		        } while (true);
